...
// @DATE:Mon Nov 19 14:19:55 GMT 2012
...
public static final controllers.ReverseBoardController BoardController = new controllers.ReverseBoardController();
public static final controllers.ReverseSession Session = new controllers.ReverseSession();
...
public static final controllers.javascript.ReverseBoardController BoardController = new controllers.javascript.ReverseBoardController();
public static final controllers.javascript.ReverseSession Session = new controllers.javascript.ReverseSession();
...
public static final controllers.ref.ReverseBoardController BoardController = new controllers.ref.ReverseBoardController();
public static final controllers.ref.ReverseSession Session = new controllers.ref.ReverseSession();
